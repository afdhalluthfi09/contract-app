...
function printDoc() {
  ...
  printWindow.document.write(`
    ...
    <html>
      <head>
        <meta charset="UTF-8">
        <title>On Boarding - ${contract.value?.namaKlien ?? ''}</title>
        <style>
          body {
          ...
          thead tr { background-color: #edf2f7; }
          ul, ol { margin-top: 5px; margin-bottom: 10px; }
          li { margin-bottom: 6px; }
          h2 { color: #4338ca; font-size: 18pt; }
          h3 { color: #2b6cb0; font-size: 13pt; }
          @page { margin: 20mm; }
        </style>
      </head>
      <body>
